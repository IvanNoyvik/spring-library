...
INSERT INTO USERS (NAME, EMAIL, STATUSES_ID) VALUES ('lock', 'qwe@mail.ru', 2);
INSERT INTO AUTHENTICATES (LOGIN, PASSWORD, UNLOCKED_DATE, USER_ID) VALUES ('qwe', '1', CURRENT_DATE(), 4);

INSERT INTO USERS (NAME, EMAIL, STATUSES_ID) VALUES ('limit', 'zak@mail.ru', 3);
INSERT INTO AUTHENTICATES (LOGIN, PASSWORD, UNLOCKED_DATE, USER_ID) VALUES ('zak', '1', DATEADD('DAY', 5, CURRENT_DATE()) , 5);

INSERT INTO MESSAGES (DATE_SENT, CONTENT, USERS_ID) VALUES ('2020-12-15', 'text', 4);
INSERT INTO MESSAGES (DATE_SENT, CONTENT, USERS_ID) VALUES (CURRENT_DATE(), 'plz', 4);
